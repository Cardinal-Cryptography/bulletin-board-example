...
import { connectWallet, disconnectWallet, updateAllAccounts } from "redux/slices/walletAccountsSlice";
...
const WalletButton = ({ setIsAccountsModalVisible, setIsMobileNavClosed, loggedAccountAddress }: WalletButtonProps): JSX.Element => {
